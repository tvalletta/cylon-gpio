...
module.exports = {
  driver: function(opts) {
    switch (opts.name) {
      ...
      case 'digitalSensor':
	return new Cylon.Drivers.GPIO.DigitalSensor(opts);
      case 'led':
  ...
  register: function(robot) {
    ...
    Logger.debug("Registering GPIO DigitalSensor driver for " + robot.name);
    robot.registerDriver('cylon-gpio', 'digitalSensor');
